...
void ddr_cfg_phy_micron_1gb(void)
{
	...
	reg32_write(0x3c080090,0x12a);
	reg32_write(0x3c0800e8,0x2);
	reg32_write(0x3c480090,0x12a);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54019,0x2ddc);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x5401f,0x2ddc);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54032,0xdc00);
	...
	reg32_write(IP2APB_DDRPHY_IPS_BASE_ADDR(0) + 4 * 0x54038,0xdc00);
